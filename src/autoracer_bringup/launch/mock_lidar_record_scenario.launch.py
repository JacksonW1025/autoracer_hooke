...
def generate_launch_description():
    ...
    default_rviz_config = _pkg_file("autoracer_bringup", "rviz", "mock_lidar_record.rviz")
    ...
    return LaunchDescription(
        [
            ...
            Node(
                ...
                name="pointcloud_map_loader_record",
                output="screen",
                parameters=[
                    {
            ...
            Node(
                ...
                executable="mock_lidar_scenario_recorder",
                name="mock_lidar_scenario_recorder",
                output="screen",
                parameters=[
                    {
                        "map_path": map_path,
                        "map_pcd_path": pointcloud_map,
