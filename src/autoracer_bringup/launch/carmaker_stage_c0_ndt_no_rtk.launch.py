...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            LogInfo(
                msg=(
                    "Starting Exp1 no-RTK aided NDT graph: correlated Fixposition noise, "
                    "NDT cross/yaw, seed along complement, no NDT regularization."
                )
            ),
            ...
            Node(
                ...
                executable="correlated_fixposition_noise",
                name="correlated_fixposition_noise",
                output="screen",
                parameters=[
                    {
                        "use_sim_time": use_sim_time,
                        "input_odom_topic": "/fixposition/odometry_enu",
                        "output_odom_topic": "/fixposition/noisy_odometry_enu",
                        "random_seed": 424242,
                        "tau_sec": 45.0,
                        "planar_stddev_m": 3.0,
                        "white_stddev_m": 0.3,
            ...
            Node(
                ...
                parameters=[
                    {
                        "use_sim_time": use_sim_time,
                        "input_odom_topic": "/fixposition/noisy_odometry_enu",
                ...
                parameters=[
                    {
                        ...
                        "max_tracking_seed_stddev_m": 5.0,
            ...
            Node(
                ...
                parameters=[
                    ndt_param_file,
                    {
                        ...
                        "validation.initial_to_result_distance_tolerance_m": 6.0,
                        ...
                        "runtime_multistart.min_stamp_sec": 20.0,
                        "runtime_multistart.trigger_initial_to_result_distance_m": 0.7,
                        "runtime_multistart.trigger_yaw_delta_deg": 2.0,
                        "runtime_multistart.trigger_score_margin": 0.2,
                        "runtime_multistart.max_prior_innovation_m": 3.0,
                        "runtime_multistart.max_prior_yaw_deg": 10.0,
                        "runtime_multistart.min_total_score": 0.0,
                        "runtime_multistart.base_candidate_raw_score_margin": 0.0,
                ...
                parameters=[
                    {
                        ...
                        "enable_robust_initial_update": True,
                        "robust_update_mode": "ekf",
                        "robust_mahalanobis_gate": 4.0,
                        ...
                        "robust_measurement_xy_variance_floor_m2": 0.09,
                        "robust_measurement_yaw_variance_floor_rad2": 0.00030461741978670857,
                        "robust_along_gain": 1.0,
                        "robust_cross_gain": 1.0,
                        "robust_yaw_gain": 0.2,
                        "robust_z_gain": 1.0,
                        "robust_roll_pitch_gain": 1.0,
                        "robust_max_along_correction_m": 6.0,
                        "robust_max_cross_correction_m": 3.0,
                        "robust_max_yaw_correction_deg": 10.0,
                        "robust_hard_reject_correction_m": 8.0,
                        "robust_hard_reject_yaw_deg": 25.0,
                        ...
                        "enable_prediction_fallback": False,
                        ...
                        "max_seed_xy_stddev_m": 5.0,
                        "fusion_mode": "ndt_cross_yaw_seed_along",
                        "along_gain": 0.03,
