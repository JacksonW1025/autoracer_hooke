...
SCENARIO_SPECS: dict[str, ScenarioSpec] = {
    ...
    "straight_120m_v3": ScenarioSpec(
        name="straight_120m_v3",
        scenario_type=FULL_VALIDATION,
        path_kind="straight",
        path_length_m=120.0,
        initial_y=0.0,
        initial_yaw=0.0,
        initial_v=3.0,
        max_duration_sec=48.0,
        max_speed=3.5,
        segments=_single_segment("straight_3mps", 120.0, 3.0),
    ),
    "arc_r30_90deg_v3": ScenarioSpec(
        name="arc_r30_90deg_v3",
        scenario_type=FULL_VALIDATION,
        path_kind="arc_left",
        path_length_m=30.0 * math.pi * 0.5,
        initial_y=0.0,
        initial_yaw=0.0,
        initial_v=3.0,
        max_duration_sec=24.0,
        max_speed=3.5,
        segments=_single_segment("arc_r30_3mps", 30.0 * math.pi * 0.5, 3.0),
        radius_m=30.0,
        arc_angle_rad=math.pi * 0.5,
    ),
    "s_curve_120m_v3": ScenarioSpec(
        name="s_curve_120m_v3",
        scenario_type=FULL_VALIDATION,
        path_kind="s_curve",
        path_length_m=120.0,
        initial_y=0.0,
        ...
        max_duration_sec=48.0,
        max_speed=3.5,
        segments=_single_segment("s_curve_3mps", 120.0, 3.0),
        s_curve_amplitude_m=1.0,
        s_curve_wavelength_m=60.0,
    ),
    "straight_160m_v5": ScenarioSpec(
        name="straight_160m_v5",
        scenario_type=FULL_VALIDATION,
        path_kind="straight",
        path_length_m=160.0,
        initial_y=0.0,
        ...
        max_speed=5.2,
        segments=_single_segment("straight_5mps", 160.0, 5.0),
    ),
    "arc_r40_90deg_v5": ScenarioSpec(
        name="arc_r40_90deg_v5",
        scenario_type=FULL_VALIDATION,
        path_kind="arc_left",
        path_length_m=40.0 * math.pi * 0.5,
        initial_y=0.0,
        initial_yaw=0.0,
        initial_v=5.0,
        max_duration_sec=22.0,
        max_speed=5.2,
        segments=_single_segment("arc_r40_5mps", 40.0 * math.pi * 0.5, 5.0),
        radius_m=40.0,
        arc_angle_rad=math.pi * 0.5,
    ),
    "s_curve_160m_v5": ScenarioSpec(
        name="s_curve_160m_v5",
        scenario_type=FULL_VALIDATION,
        path_kind="s_curve",
        path_length_m=160.0,
        initial_y=0.0,
        ...
        max_duration_sec=40.0,
        max_speed=5.2,
        segments=_single_segment("s_curve_5mps", 160.0, 5.0),
        s_curve_amplitude_m=1.0,
        s_curve_wavelength_m=80.0,
    ),
}
