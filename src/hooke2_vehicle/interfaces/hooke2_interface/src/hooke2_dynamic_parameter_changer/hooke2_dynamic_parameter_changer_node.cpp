...
#include <hooke2_dynamic_parameter_changer/hooke2_dynamic_parameter_changer_node.hpp>

#include <algorithm>

Hooke2DynamicParameterChangerNode::Hooke2DynamicParameterChangerNode()
: Node("hooke2_dynamic_parameter_changer")
{
  ...
  steer_rpt_sub_ = create_subscription<hooke2_msgs::msg::SystemRptFloat>(
    "~/input/steer_rpt", rclcpp::QoS{1},
    std::bind(&Hooke2DynamicParameterChangerNode::subSteerRpt, this, _1));
}

void Hooke2DynamicParameterChangerNode::subSteerRpt(
  const hooke2_msgs::msg::SystemRptFloat::ConstSharedPtr msg)
{
...
ParamList Hooke2DynamicParameterChangerNode::calculateParam(
...
void Hooke2DynamicParameterChangerNode::sendDebugMsg(const ParamList param_list)
{
  // publish debug msg
...
void Hooke2DynamicParameterChangerNode::sendCanMsg(const ParamList param_list)
{
  // encoding
...
ParamList Hooke2DynamicParameterChangerNode::interpolateParam(
...
ParamList Hooke2DynamicParameterChangerNode::rateLimit(
...
double Hooke2DynamicParameterChangerNode::rateLimit(
