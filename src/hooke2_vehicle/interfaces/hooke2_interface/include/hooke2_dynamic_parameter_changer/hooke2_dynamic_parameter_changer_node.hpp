...
#ifndef HOOKE2_DYNAMIC_PARAMETER_CHANGER__HOOKE2_DYNAMIC_PARAMETER_CHANGER_NODE_HPP_
#define HOOKE2_DYNAMIC_PARAMETER_CHANGER__HOOKE2_DYNAMIC_PARAMETER_CHANGER_NODE_HPP_
...
class Hooke2DynamicParameterChangerNode : public rclcpp::Node
{
  private:
    rclcpp::Publisher<std_msgs::msg::Float32MultiArray>::SharedPtr debug_pub_;
    rclcpp::Publisher<can_msgs::msg::Frame>::SharedPtr can_pub_;
    rclcpp::Subscription<hooke2_msgs::msg::SystemRptFloat>::SharedPtr steer_rpt_sub_;
  ...
  public:
    Hooke2DynamicParameterChangerNode();
    void subSteerRpt(const hooke2_msgs::msg::SystemRptFloat::ConstSharedPtr msg);
...
#endif  // HOOKE2_DYNAMIC_PARAMETER_CHANGER__HOOKE2_DYNAMIC_PARAMETER_CHANGER_NODE_HPP_
