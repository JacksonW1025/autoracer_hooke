...
#define NODE_MAIN_LOGGER_NAME "autoware_pose_covariance_modifier_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libautoware_pose_covariance_modifier.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<autoware::pose_covariance_modifier::PoseCovarianceModifierNode>";
