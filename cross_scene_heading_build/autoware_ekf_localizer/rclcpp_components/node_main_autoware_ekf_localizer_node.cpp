...
#define NODE_MAIN_LOGGER_NAME "autoware_ekf_localizer_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libautoware_ekf_localizer.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<autoware::ekf_localizer::EKFLocalizer>";
